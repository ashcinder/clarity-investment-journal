...
日常录入只需 **资产名称、当前金额、收益率**。当前金额填写平台显示的资产总价值（已包含盈亏），网格填写当前总权益。资产类型默认跟随账户，用于配置比例图；无需填写代码、币数 / 份额、成本单价、当前价格或杠杆。币种由账户决定，直接显示在金额标签中。

- 反算本金 =（当前金额 + 历史取出金额）÷（1 + 收益率）。
- 收益金额 = 当前金额 + 历史取出金额 − 反算本金。
